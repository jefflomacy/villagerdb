    ...
    for (let gameId in format.games) {
        ...
        if (game) {
            ...
            formatted.gamesData[gameId] = {
                ...
                bellCost: bellCost.map(format.numberLocale),
                meowCost: meowCost.map(format.numberLocale),
                milesCost: milesCost.map(format.numberLocale),
                sellable: bellPrice.length > 0,
                bellPrice: bellPrice.map(format.numberLocale),
